                        ...
                        if (drawerItem != null) {
                            ...
                            if (drawerItem.getIdentifier() == 1) {
                               // intent = new Intent(SimpleHeaderDrawerActivity.this, SimpleCompactHeaderDrawerActivity.class);
                                intent  = new Intent(SimpleHeaderDrawerActivity.this, BlankActivity.class);
                            } else if (drawerItem.getIdentifier() == 2) {
                               // intent =ten new Intent(SimpleHeaderDrawerActivity.this, ActionBarDrawerActivity.class);
                               ...
                               // intent = new Intent(SimpleHeaderDrawerActivity.this, FullscreenDrawerActivity.class);
                                ...
                                intent = new Intent(SimpleHeaderDrawerActivity.this, SettingsActivity.class);
